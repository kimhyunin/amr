...
def generate_launch_description():
    ...
    cartographer_config_dir = LaunchConfiguration('cartographer_config_dir',
        default=os.path.join(get_package_share_directory('mywaybot_slam') , 'config'))
    ...
    rviz_config_dir = os.path.join(get_package_share_directory('mywaybot_slam'), 'rviz', 'slam.rviz')
